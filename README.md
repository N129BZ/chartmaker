...
### Requirements: Sqlite3 (tested with v3.40.1), Python (tested with 3.11.4) , Nodejs + npm, Perl v5.36.0, pngquant 2.17.0, imagemagick, curl, unzip, build-essential, GDAL v3.6.2 (minimum)
